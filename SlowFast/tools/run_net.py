...
# Ensure proper relative import from tools/ directory
...
def main():
    ...
    for path_to_config in args.cfg_files:
        ...
        # 💡 single GPU라면 init_method를 None으로 강제
        init_method = args.init_method
        if cfg.NUM_GPUS == 1:
            init_method = None
            print("Single GPU detected. Distributed init disabled.")
        ...
        if cfg.TENSORBOARD.ENABLE and (
            ...
            launch_job(cfg=cfg, init_method=init_method, func=visualize)
